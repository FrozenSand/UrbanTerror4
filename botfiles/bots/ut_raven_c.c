...
skill 1
{
	CHARACTERISTIC_NAME							"raven"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_raven_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_raven_t.c"
	CHARACTERISTIC_CHAT_NAME					"raven"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_raven_i.c"
