...
skill 1
{
	CHARACTERISTIC_NAME							"puma"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_puma_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_puma_t.c"
	CHARACTERISTIC_CHAT_NAME					"puma"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_puma_i.c"
