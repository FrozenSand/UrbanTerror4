...
skill 1
{
	CHARACTERISTIC_NAME							"goose"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_goose_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_goose_t.c"
	CHARACTERISTIC_CHAT_NAME					"goose"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_goose_i.c"
