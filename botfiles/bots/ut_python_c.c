...
skill 1
{
	CHARACTERISTIC_NAME							"python"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_python_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_python_t.c"
	CHARACTERISTIC_CHAT_NAME					"python"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_python_i.c"
