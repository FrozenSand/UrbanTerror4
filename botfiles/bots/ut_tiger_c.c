...
skill 1
{
	CHARACTERISTIC_NAME							"tiger"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_tiger_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_tiger_t.c"
	CHARACTERISTIC_CHAT_NAME					"tiger"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_tiger_i.c"
