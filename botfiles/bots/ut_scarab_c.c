...
skill 1
{
	CHARACTERISTIC_NAME							"scarab"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_scarab_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_scarab_t.c"
	CHARACTERISTIC_CHAT_NAME					"scarab"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_scarab_i.c"
