...
skill 1
{
	CHARACTERISTIC_NAME							"widow"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_widow_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_widow_t.c"
	CHARACTERISTIC_CHAT_NAME					"widow"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_widow_i.c"
