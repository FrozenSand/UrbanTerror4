...
skill 1
{
	CHARACTERISTIC_NAME							"cougar"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_cougar_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_cougar_t.c"
	CHARACTERISTIC_CHAT_NAME					"cougar"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_cougar_i.c"
