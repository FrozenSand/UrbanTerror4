...
skill 1
{
	CHARACTERISTIC_NAME							"drop"
	CHARACTERISTIC_GENDER						"female"
	CHARACTERISTIC_ATTACK_SKILL					1.0
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_drop_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_drop_t.c"
	CHARACTERISTIC_CHAT_NAME					"drop"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_drop_i.c"
