...
skill 1
{
	CHARACTERISTIC_NAME							"cockroach"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_cockroach_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_cockroach_t.c"
	CHARACTERISTIC_CHAT_NAME					"cockroach"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_cockroach_i.c"
