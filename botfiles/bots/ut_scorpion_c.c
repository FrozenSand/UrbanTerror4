...
skill 1
{
	CHARACTERISTIC_NAME							"scorpion"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_scorpion_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_scorpion_t.c"
	CHARACTERISTIC_CHAT_NAME					"scorpion"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_scorpion_i.c"
