...
skill 1
{
	CHARACTERISTIC_NAME							"mantis"
	CHARACTERISTIC_GENDER						"male"
	CHARACTERISTIC_ATTACK_SKILL					0.3
	CHARACTERISTIC_WEAPONWEIGHTS				"bots/ut_mantis_w.c"
	...
	CHARACTERISTIC_CHAT_FILE					"bots/ut_mantis_t.c"
	CHARACTERISTIC_CHAT_NAME					"mantis"
	...
	CHARACTERISTIC_ITEMWEIGHTS					"bots/ut_mantis_i.c"
